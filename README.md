...
<div align="center"><img src="https://github.com/Vatis-Tech/asr-client-js-html-js-example/blob/main/assets/img/brand/asr-client-js-html-js-example.png?raw=true" alt="asr-client-js-html-js-example"/></div>
...
1. Download the project by pressing [this link here](https://github.com/Vatis-Tech/asr-client-js-html-js-example/archive/refs/heads/main.zip).
2. Unzip the downloaded content.
3. Or, you can clone it with the following command `git clone https://github.com/Vatis-Tech/asr-client-js-html-js-example.git`
4. Go inside `assets/js/index.js`, and replace `YOUR_API_KEY_HERE`, with a valid **API Key** from https://vatis.tech/account/api-key.
5. Open `index.html` in the browser of your choice.
...
Our community is safe for all. Before submitting a pull request, please review and agree our [Code of Conduct](https://github.com/Vatis-Tech/asr-client-js-html-js-example/blob/main/CODE_OF_CONDUCT.md), after that, please check the [Contribution](https://github.com/Vatis-Tech/asr-client-js-html-js-example/blob/main/CONTRIBUTING.md) guidelines.
...
To keep the README a bit lighter, you can read the [Changelog here](https://github.com/Vatis-Tech/asr-client-js-html-js-example/blob/main/CHANGELOG.md).
